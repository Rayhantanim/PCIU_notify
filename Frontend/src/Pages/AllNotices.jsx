  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
      <div className="container mx-auto px-4 py-8">
        {/* Header */}
    <div className="bg-gradient-to-r from-cyan-500 to-indigo-600 rounded-2xl shadow-xl p-6 mb-8 text-white">
  <h1 className="text-3xl font-bold mb-2">🎯 Notice Board</h1>
  <p className="text-cyan-100">Your central hub for all notifications</p>
</div>
